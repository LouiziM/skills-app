...
const TrainingCalendar = ({
  ...
  const calendarEvents = useMemo(() => trainings.map(training => ({
    id: training.id,
  ...
  return (
    <div className="grid grid-cols-1 gap-4 xl:grid-cols-3 xl:max-w-[1162px] xl:mx-auto xl:gap-4">
      <Card className="xl:col-span-2 shadow-lg pt-6 w-full ">
        <CardContent>
          <BigCalendar
            localizer={localizer}
        ...
        <CardContent>
          <ScrollArea className="h-[70vh]">
            {selectedTrainings.length > 0 ? (
              selectedTrainings.map(training => renderTrainingCardWithActions(
                training,
                onViewDetails,
                onEditTraining,
                onDeleteTraining,
