          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="sticky top-0 bg-background cursor-pointer" onClick={() => requestSort("tauxPresence")}>
                  Taux de Présence {sortConfig?.key === "tauxPresence" ? (sortConfig.direction === "ascending" ? "↑" : "↓") : ""}
                </TableHead>
                <TableHead className="sticky top-0 bg-background cursor-pointer" onClick={() => requestSort("productiviteHoraire")}>
                  Productivité Horaire {sortConfig?.key === "productiviteHoraire" ? (sortConfig.direction === "ascending" ? "↑" : "↓") : ""}
                </TableHead>
                <TableHead className="sticky top-0 bg-background cursor-pointer" onClick={() => requestSort("tauxResolution")}>
                  Taux de Résolution {sortConfig?.key === "tauxResolution" ? (sortConfig.direction === "ascending" ? "↑" : "↓") : ""}
                </TableHead>
                <TableHead className="sticky top-0 bg-background cursor-pointer" onClick={() => requestSort("satisfactionClient")}>
                  Satisfaction Client {sortConfig?.key === "satisfactionClient" ? (sortConfig.direction === "ascending" ? "↑" : "↓") : ""}
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
